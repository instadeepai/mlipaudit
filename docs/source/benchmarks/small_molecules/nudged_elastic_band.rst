...
to run NEB calculations. The strucutres of reactants and products are energy minimized using the **MLIP** and the **BFGS** optimizer with alpha=70 and maxstep=0.03.

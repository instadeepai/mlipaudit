...
#: Relative-deviation threshold used to score density benchmarks: the equilibrium
#: density is scored via `compute_metric_score(density_deviation / reference_density,
#: DENSITY_RELATIVE_DEVIATION_THRESHOLD, ALPHA)`. A deviation at or below this fraction
#: of the reference density scores 1.0; larger deviations decay exponentially.
#: TODO: Confirm this threshold with the science team (Marco/Silvia) before release.
DENSITY_RELATIVE_DEVIATION_THRESHOLD = 0.05
